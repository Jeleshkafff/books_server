...
export async function add(reader,date_in, date_out,ret,date_out_real) {
    return db.connection.query(
      `insert into moving (reader,date_in, date_out,ret,date_out_real) values{${reader},${book},${stringify (date_in)}, ${stringify (date_out)},${ret},${stringify(date_out_real)});`
    );
  }
